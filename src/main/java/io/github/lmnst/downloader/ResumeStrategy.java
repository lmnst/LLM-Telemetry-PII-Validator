 ...
 * {@code <dest>.part.meta} sidecar) is treated when {@link Downloader#download}
 * is called.
 */
...
public enum ResumeStrategy {
    ...
    /**
     * Always start from scratch. Any existing {@code .part} / {@code .part.meta}
    ...
    /**
     * Reuse an existing {@code .part} / {@code .part.meta} sidecar if one is
